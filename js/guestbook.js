/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="/javascript/comment-widget.js"></script>
...
const s_formId = '1FAIpQLSdTrV12MJVcPoxIPUZWm3msjNh-NAf-un_p77tuTSWG8pQaXw';
const s_nameId = '859951854';
const s_websiteId = '1735834689';
const s_textId = '803968093';
const s_adminId = '89670471';
const s_pageId = '1925039865';
const s_replyId = '527337074';
const s_sheetId = '1c2KVGdQFAH11CIrTgV0U31P6e4jyqEstntRAZt4Pg9M';
...
const s_maxLengthName = 17; // The max character length of a name
...
const s_widgetTitle = 'want to leave a comment?';
...
const v_formHtml = `
    ...
    <div class="row" style="display: flex; flex-wrap: nowrap;">
        <div id="c_nameWrapper" class="c-inputWrapper">
            <label class="c-label c-nameLabel" for="entry.${s_nameId}" style="padding-bottom: 8px;"></label>
        ...
        <div id="c_websiteWrapper" class="c-inputWrapper">
            <label class="c-label c-websiteLabel" for="entry.${s_websiteId}"></label>
    ...
    <div id="c_textWrapper" class="c-inputWrapper">
        ...
        <textarea class="c-input c-textInput" name="entry.${s_textId}" id="entry.${s_textId}" rows="4" cols="50"  maxlength="${s_maxLength}" placeholder="Text (Required)." required></textarea>
...
function createComment(data) {
    ...
    if(data.Admin == true) {
        name.insertAdjacentHTML('beforeend', " <span id='c_admin'>[Admin]</span>");
    }
    if (data.Pinned == true) {
        name.insertAdjacentHTML("beforeend", " <span id='c_admin'>[Pinned]</span>");
    }
